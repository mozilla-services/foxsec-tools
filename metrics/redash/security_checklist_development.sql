...
concat('<a href="https://sql.telemetry.mozilla.org/dashboard/firefox-secops-checklist-details?p_service_59954=', service, '&p_environment_59954=development&p_item_59954=', item, '">', item, '</a>') as item,
passes,
failures,
